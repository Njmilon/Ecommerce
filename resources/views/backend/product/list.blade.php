                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a onclick="return confirm('Are you sure you want to delete this item?');"
                            href="{{ route('Product.delete', $product->id) }}" class="btn btn-danger"
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="number" class="form-control" id="productPrice" name="productPrice"
                                placeholder="Enter Product Price">
                        </div>
                        <div>
                            <label for="productDescription">Description:</label>
                        
                            <textarea required cols="5" rows="5" class="form-control" name="productDescription" id="productDescription"
